...
namespace Meowgic.Match.UI
{
    public class SpellPreparationController : MonoBehaviour
    {
        ...
        public void SelectSpell()
        {
            ...
            root.AvailableSpells.Data = root.Data.CastArgs.Caster.Spells;
        ...
        {
            GetComponentInParent<PreparationController>().DeactivateAll();
            if (!root.Data.CastArgs.spell) return;

            _catalystIndex = index;
            var cost = root.Data.CastArgs.Cost[index];
            var hand = root.Data.CastArgs.Caster.Side.Pool.Hand;
        ...
        public void SetCatalyst(CatalystView view)
        {
            ...
            //select next
            if (_catalystIndex < root.Data.CastArgs.Cost.Count - 1)
